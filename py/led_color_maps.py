...
class lspi_color_maps:

    map = {    
'GRADED_GREEN_WHITE': [colors.Green for g in range(5)] + \
...
,
'DALLAS_STARS': [colors.Green for g in range(5)] + \
                         [colors.Green for g in range(15)] + \
                         [colors.Snow for g in range(31)] + \
                         [colors.Green for g in range(47)] + \
                         [colors.Green for g in range(63)] + \
                         ...
                         [colors.Green for g in range(250)]
,
'XMAS': [colors.Green for g in range(5)] + \
...
,
'FOURTH_JULY': [colors.Snow for g in range(5)] + \
...
,
'VALENTINE': [colors.Red for g in range(5)] + \
                         ...
                         [colors.Red for g in range(250)]
,
'NEW_YEARS': [colors.Silver for g in range(5)] + \
                         [colors.Gold for g in range(15)] + \
...
,
'CHANUKAH': [colors.Silver for g in range(5)] + \
                         [colors.Blue for g in range(15)] + \
...
,
'FALL': [colors.Sienna for g in range(5)] + \
